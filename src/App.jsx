...
const GLOBAL_STYLES = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* Aquarium fish swimming left to right — fish face right naturally */
  @keyframes swimRight {
  ...
  /* Aquarium fish swimming right to left — flip the whole element so fish face left */
  @keyframes swimLeft {
...
/* ─── AQUARIUM NAV FISH ─── */
const NAV_FISH = [
  { emoji: "🐠", size: 22, top: 8,  duration: 18, delay: 0  },
  { emoji: "🐟", size: 16, top: 30, duration: 26, delay: 6  },
  { emoji: "🐡", size: 14, top: 12, duration: 20, delay: 12 },
  { emoji: "🐠", size: 18, top: 24, duration: 22, delay: 3  },
  { emoji: "🐟", size: 13, top: 6,  duration: 28, delay: 9  },
];

function AquariumNav({ onHome }) {
  return (
    <nav style={{
      ...
      <div style={{
        ...
        >
          <img src="/src/catfish_logo.png" alt="logo"
  ...
  return (
    <div style={{ position: "fixed", bottom: 0, left: 0, right: 0, height: "56px", overflow: "hidden" }}>
      ...
      <svg viewBox="0 0 1440 56" preserveAspectRatio="none"
        style={{ position: "absolute", bottom: 0, left: 0, width: "100%", height: "100%", zIndex: 2, pointerEvents: "none" }}>
        <defs>
          <clipPath id="fillClip">
            <rect x="0" y="0" width={`${pct}%`} height="56" />
          </clipPath>
        </defs>
        <path clipPath="url(#fillClip)"
          d="M0,28 C180,0 360,56 540,28 C720,0 900,56 1080,28 C1260,0 1440,42 1440,28 L1440,56 L0,56 Z"
          fill="#7dd3fc" opacity="0.6" />
        <path clipPath="url(#fillClip)"
          d="M0,36 C200,10 400,52 600,32 C800,12 1000,52 1200,32 C1320,20 1400,40 1440,36 L1440,56 L0,56 Z"
          fill="#0ea5e9" opacity="0.8" />
        {/* Seaweed */}
        {[5, 15, 28, 42, 58, 72, 86, 95].map((left, i) => (
          <rect key={i}
            x={`${left}%`} y={56 - 10 - (i % 3) * 6}
            width="4" height={10 + (i % 3) * 6}
            fill="rgba(52,211,153,0.45)" rx="2"
      ...
      <div style={{ position: "absolute", inset: 0, zIndex: 3, pointerEvents: "none", overflow: "hidden" }}>
        {BAR_FISH.map((f, i) => (
          <span key={i} style={{
            ...
            animation: `swimRight ${f.duration}s linear ${f.delay}s infinite`,
          }}>{f.emoji}</span>
        ))}
        {/* Bubbles */}
        {[20, 45, 68, 88].map((left, i) => (
          <div key={i} style={{
            ...
            animation: `floatUp ${1.6 + i * 0.4}s ease-in ${i * 0.6}s infinite`,
          }} />
        ))}
      </div>
      ...
      <div style={{
        ...
        color: pct > 85 ? "#fff" : "#0369a1",
        fontSize: "12px", fontWeight: "700", zIndex: 4, fontFamily: "monospace",
      }}>{step} / {total}</div>
    </div>
  );
}
...
function BottomWaves() {
  return (
    <svg viewBox="0 0 1440 120" preserveAspectRatio="none"
      style={{ position: "absolute", bottom: "56px", left: 0, width: "100%", height: "120px", zIndex: 0 }}>
      <path d="M0,60 C360,120 720,0 1080,60 C1260,90 1380,40 1440,60 L1440,120 L0,120 Z"
        fill="#0c4a6e" opacity="0.08" />
      <path d="M0,80 C240,40 480,110 720,80 C960,50 1200,100 1440,80 L1440,120 L0,120 Z"
  ...
  return (
    <div className="static-bg" style={{
      ...
      <svg viewBox="0 0 200 60"
        style={{ position: "absolute", top: "110px", left: "8%", width: "120px", opacity: 0.4 }}>
      ...
      <div className="fade-in" style={{ textAlign: "center", maxWidth: "640px", zIndex: 1 }}>
        <div style={{
          ...
          textTransform: "uppercase", color: "#0369a1", marginBottom: "16px", fontFamily: "monospace",
        }}>✦ Welcome ✦</div>

        <h1 style={{
          fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: "clamp(48px, 8vw, 80px)",
          fontWeight: "800", lineHeight: 1.05, color: "#0c4a6e", marginBottom: "24px",
        }}>
          Ride the Wave<br />
          <span style={{
        ...
        <p style={{
          fontSize: "clamp(16px, 2.5vw, 22px)", color: "#075985", lineHeight: 1.6,
          fontWeight: "500", maxWidth: "480px", margin: "0 auto 48px",
        }}>
        ...
        <button onClick={onStart} style={{
          background: "linear-gradient(135deg, #0284c7, #0ea5e9)", border: "none",
          borderRadius: "100px", padding: "18px 56px", color: "#fff",
          fontSize: "18px", fontWeight: "700", cursor: "pointer", fontFamily: "inherit",
          boxShadow: "0 8px 32px rgba(2,132,199,0.4)", letterSpacing: "0.04em",
          transition: "transform 0.15s, box-shadow 0.15s", display: "block", margin: "0 auto",
        }}
          onMouseEnter={(e) => {
            e.currentTarget.style.transform = "translateY(-3px)";
            e.currentTarget.style.boxShadow = "0 14px 40px rgba(2,132,199,0.5)";
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.transform = "translateY(0)";
            e.currentTarget.style.boxShadow = "0 8px 32px rgba(2,132,199,0.4)";
          }}
        >Let's Start →</button>

        <p style={{ marginTop: "16px", color: "#0369a1", fontSize: "13px", opacity: 0.7 }}>
  ...
  return (
    <div className="static-bg" style={{
      ...
      <div className="fade-in" style={{
        ...
        borderRadius: "28px", border: "1.5px solid rgba(255,255,255,0.8)",
        padding: "48px 40px",
        boxShadow: "0 8px 48px rgba(2,132,199,0.15), 0 2px 8px rgba(0,0,0,0.06)", zIndex: 1,
      }}>
        <div style={{
          display: "inline-block", background: "rgba(14,165,233,0.12)", color: "#0284c7",
          borderRadius: "100px", padding: "4px 14px", fontSize: "12px", fontWeight: "700",
          fontFamily: "monospace", letterSpacing: "0.1em", marginBottom: "20px",
        }}>STEP 1 OF 3</div>

        <h2 style={{
          fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: "30px", fontWeight: "800",
          color: "#0c4a6e", marginBottom: "8px", lineHeight: 1.1,
        }}>
        ...
        <p style={{ color: "#0369a1", fontSize: "14px", marginBottom: "32px", lineHeight: 1.5, opacity: 0.8 }}>
          We'll use these to fetch your assignments securely.
        </p>

        <div style={{ marginBottom: "16px" }}>
          <label style={{
            display: "block", fontSize: "13px", fontWeight: "700", color: "#0369a1",
            marginBottom: "8px", letterSpacing: "0.05em", textTransform: "uppercase", fontFamily: "monospace",
          }}>Username</label>
        ...
        <div style={{ marginBottom: "28px" }}>
          ...
          <div style={{ position: "relative" }}>
            ...
            <button onClick={() => setShowPassword(!showPassword)} style={{
              ...
              background: "none", border: "none", cursor: "pointer", color: "#0369a1", fontSize: "16px", opacity: 0.6,
            }}>{showPassword ? "🙈" : "👁️"}</button>
          </div>
        </div>

        <button onClick={() => ready && onLogin()} style={{
          width: "100%",
          background: ready ? "linear-gradient(135deg, #0284c7, #0ea5e9)" : "rgba(186,230,253,0.5)",
          border: "none", borderRadius: "14px", padding: "16px",
          color: ready ? "#fff" : "#93c5fd", fontSize: "16px", fontWeight: "700",
          cursor: ready ? "pointer" : "not-allowed", fontFamily: "inherit",
          letterSpacing: "0.04em", transition: "all 0.2s",
          boxShadow: ready ? "0 6px 24px rgba(2,132,199,0.35)" : "none", marginBottom: "12px",
        }}
          onMouseEnter={(e) => {
            if (ready) {
              e.currentTarget.style.transform = "translateY(-2px)";
              e.currentTarget.style.boxShadow = "0 10px 32px rgba(2,132,199,0.45)";
            }
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.transform = "translateY(0)";
            e.currentTarget.style.boxShadow = ready ? "0 6px 24px rgba(2,132,199,0.35)" : "none";
          }}
        >Log In</button>

        <button onClick={onBack} style={{
          width: "100%", background: "none",
          border: "1.5px solid rgba(186,230,253,0.8)", borderRadius: "14px",
          padding: "13px", color: "#0369a1", fontSize: "14px", fontWeight: "600",
        ...
        <p style={{ textAlign: "center", marginTop: "16px", color: "#0369a1", fontSize: "12px", opacity: 0.6 }}>
...
function LoadingScreen({ onDone }) {
  ...
  return (
    <div className="static-bg-loading" style={{
      ...
      <div style={{
        ...
        <div style={{ position: "relative", width: "200px", height: "200px" }}>
          ...
          <div style={{
            ...
            <img src="/src/loading-logo.png" alt="logo"
          ...
          <div style={{
            ...
            animation: "fishOrbit1 3s linear infinite",
          }}>
          ...
          <div style={{
            position: "absolute", top: "50%", left: "50%",
            marginTop: "-12px", marginLeft: "-12px",
            animation: "fishOrbit2 3s linear infinite",
          }}>
          ...
          <div style={{
            position: "absolute", top: "50%", left: "50%",
            marginTop: "-12px", marginLeft: "-12px",
            animation: "fishOrbit3 3s linear infinite",
          }}>
        ...
        <div style={{ minHeight: "32px" }}>
          <p key={msgIndex} className="fade-msg" style={{
            fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: "20px", fontWeight: "700",
            color: "#0c4a6e", opacity: fade ? 1 : 0, transition: "opacity 0.3s",
        ...
        <div style={{ width: "280px" }}>
          ...
          <p style={{
            ...
            color: "#0369a1", fontFamily: "monospace", fontWeight: "600",
          }}>{progress}%</p>
        </div>
      </div>
      <BottomWaves />
  ...
  return (
    <div className="static-bg" style={{
      ...
      <div className="pop-in" style={{
        width: "100%", maxWidth: "720px", zIndex: 1,
        background: "rgba(255,255,255,0.55)", backdropFilter: "blur(20px)",
        borderRadius: "28px", border: "1.5px solid rgba(255,255,255,0.8)",
        padding: "40px",
        boxShadow: "0 8px 48px rgba(2,132,199,0.15), 0 2px 8px rgba(0,0,0,0.06)",
      }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "24px" }}>
          <div>
            <div style={{
              display: "inline-block", background: "rgba(14,165,233,0.12)", color: "#0284c7",
              borderRadius: "100px", padding: "4px 14px", fontSize: "12px", fontWeight: "700",
              fontFamily: "monospace", letterSpacing: "0.1em", marginBottom: "12px",
            }}>STEP 3 OF 3</div>
            <h2 style={{
              fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: "30px", fontWeight: "800",
              color: "#0c4a6e", lineHeight: 1.1,
            }}>Your assignments 🎉</h2>
            <p style={{ color: "#0369a1", fontSize: "14px", marginTop: "6px", lineHeight: 1.5 }}>
              {SAMPLE_ASSIGNMENTS.length} assignments found
            </p>
          </div>
          <button onClick={handleCopy} style={{
            background: copied ? "rgba(16,185,129,0.15)" : "rgba(255,255,255,0.7)",
            border: `1.5px solid ${copied ? "rgba(16,185,129,0.5)" : "rgba(186,230,253,0.8)"}`,
            ...
            <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "13px" }}>
                ...
                <tr style={{ background: "rgba(2,132,199,0.12)", position: "sticky", top: 0, zIndex: 1 }}>
                  {["Course Name", "Assignment", "Deadline"].map((h) => (
                    <th key={h} style={{
                      ...
                      color: "#0369a1", fontFamily: "monospace", fontWeight: "700",
              ...
              <tbody>
                {SAMPLE_ASSIGNMENTS.map((a, i) => (
                  <tr key={i} style={{
                    background: i % 2 === 0 ? "rgba(255,255,255,0.5)" : "rgba(186,230,253,0.15)",
                    borderBottom: "1px solid rgba(186,230,253,0.3)",
                  }}>
                    <td style={{
                      padding: "10px 16px", color: "#075985",
                      fontWeight: "600", fontSize: "12px", maxWidth: "220px",
                      overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap",
                    }}>
                      {a.courseName}
                    </td>
                    <td style={{
                      padding: "10px 16px", color: "#0c4a6e",
                      fontWeight: "700", fontSize: "13px",
                    }}>
                      {a.name}
                    </td>
                    <td style={{
                      padding: "10px 16px", color: "#0369a1",
        ...
        {/* Download row */}
        <p style={{
          fontSize: "12px", fontWeight: "700", color: "#0369a1", marginBottom: "10px",
        ...
        <div style={{ display: "flex", gap: "10px", alignItems: "center", marginBottom: "10px" }}>
          ...
          <button onClick={handleDownload} style={{
            background: "linear-gradient(135deg, #0284c7, #0ea5e9)", border: "none",
            borderRadius: "12px", padding: "11px 22px", color: "#fff",
            fontSize: "14px", fontWeight: "700", cursor: "pointer", fontFamily: "inherit",
            whiteSpace: "nowrap", boxShadow: "0 4px 16px rgba(2,132,199,0.35)", transition: "all 0.2s",
          }}
            onMouseEnter={(e) => {
              e.currentTarget.style.transform = "translateY(-2px)";
        ...
        {downloaded && (
          <p className="fade-in" style={{ fontSize: "13px", color: "#0284c7", fontWeight: "600", marginBottom: "8px" }}>
        ...
        <button onClick={handleCalendar} style={{
          ...
          border: "2px solid rgba(186,230,253,0.8)", background: "rgba(255,255,255,0.6)",
          color: "#0369a1", fontSize: "14px", fontWeight: "700", cursor: "pointer",
          fontFamily: "inherit", display: "flex", alignItems: "center",
          justifyContent: "center", gap: "10px", transition: "all 0.2s", marginBottom: "10px",
        }}
          onMouseEnter={(e) => {
        ...
        >
          <img src="/src/google_calendar.png" alt="Google Calendar"
            style={{ width: "22px", height: "22px", objectFit: "contain" }} />
          Add to Google Calendar
        </button>

        {calendarAdded && (
          <p className="fade-in" style={{ fontSize: "13px", color: "#0284c7", fontWeight: "600", marginBottom: "10px" }}>
            ✅ Assignments added to Google Calendar!
          </p>
        )}
        ...
        <button onClick={onRestart} style={{
          width: "100%", background: "none",
          border: "1.5px solid rgba(186,230,253,0.8)", borderRadius: "12px",
          padding: "12px", color: "#0369a1", fontSize: "14px", fontWeight: "600",
          cursor: "pointer", fontFamily: "inherit", transition: "all 0.2s",
        }}
          onMouseEnter={(e) => (e.currentTarget.style.background = "rgba(255,255,255,0.4)")}
          onMouseLeave={(e) => (e.currentTarget.style.background = "none")}
...
export default function App() {
  ...
  return (
    <>
      ...
      <AquariumNav onHome={step > 0 ? () => setStep(0) : null} />
      ...
      {/* step 0=welcome(1/3), 1=login(2/3), 2=loading(2/3 still), 3=done(3/3) */}
